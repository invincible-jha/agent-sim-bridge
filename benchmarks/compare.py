"""Comparison visualiser for agent-sim-bridge benchmark results."""
...
def main() -> None:
    ...
    print(f"\n{'=' * 80}")
    print("  agent-sim-bridge Benchmark Results")
    print(f"{'=' * 80}")
    ...
    print("    python benchmarks/bench_sim_throughput.py")
    print("    python benchmarks/bench_gap_latency.py")
