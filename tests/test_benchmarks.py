"""Structural tests for agent-sim-bridge benchmarks.
...
def test_bench_sim_throughput_returns_expected_keys() -> None:
    """bench_scenario_evaluation_throughput returns a dict with required keys."""
    from bench_sim_throughput import run_benchmark
...
def test_bench_sim_throughput_ops_per_second_positive() -> None:
...
def test_bench_gap_latency_returns_expected_keys() -> None:
    """bench_gap_estimation_latency returns a dict with required keys."""
    from bench_gap_latency import run_benchmark
...
def test_bench_gap_latency_p99_present() -> None:
...
def test_bench_memory_usage_returns_expected_keys() -> None:
    """bench_gap_estimation_memory returns a dict with required keys."""
