# Contributing to agent-sim-bridge

Thank you for contributing to agent-sim-bridge, part of the AumOS portfolio.
...
```bash
git clone https://github.com/aumos-ai/agent-sim-bridge.git
cd agent-sim-bridge
pip install -e ".[dev]"
```
